...
export default function LandingHero() {
	return (
		<section className="relative overflow-hidden rounded-[1.6rem] border border-[#e6dcc8] bg-[#fbfaf6] px-5 py-8 shadow-sm dark:border-[#243044] dark:bg-[#08111f] sm:px-8 lg:px-12 lg:py-12">
			<div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_8%_0%,rgba(255,255,255,0.88),transparent_24%),radial-gradient(circle_at_60%_115%,rgba(139,163,194,0.22),transparent_38%)] dark:bg-[radial-gradient(circle_at_16%_0%,rgba(48,73,106,0.55),transparent_28%),radial-gradient(circle_at_62%_104%,rgba(214,189,124,0.11),transparent_34%)]" />
			<div className="pointer-events-none absolute -bottom-24 left-0 right-0 h-48 rounded-[50%] border-t border-[#d6bd7c]/45 bg-[radial-gradient(ellipse_at_center,rgba(15,23,42,0.12),transparent_64%)] opacity-60 dark:border-[#d6bd7c]/35 dark:bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.13),transparent_64%)] sm:-bottom-28 sm:h-56 md:opacity-100" />
